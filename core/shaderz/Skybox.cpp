...
namespace shaderz {
	...
	Skybox::Skybox(Shader& skyboxShader, std::string hdrFile)
	{
		this->skyboxShader = &skyboxShader;
		this->skyboxShader->use();
		this->skyboxShader->setInt("equirectangularMap", 0);
	...
	unsigned int Skybox::loadHDR(std::string hdrFile)
	{
		stbi_set_flip_vertically_on_load(false);
		float* data = stbi_loadf("assets/sky.hdr", &width, &height, &nrChannels, 0);
